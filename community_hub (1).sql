...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 29, 2024 at 08:14 AM
...
--
-- Table structure for table `community_profile`
--
...
--
-- Dumping data for table `community_profile`
--

INSERT INTO `community_profile` (`id`, `user_id`, `community_id`, `name`, `bio`, `profile_image`) VALUES
(1, 14, 1, 'Sajid_Ali', 'You need to have a great Instagram bio to make your profile stand out among others. It will also show your personality to the visitors on your profile and your followers. A great bio for Instagram can also make the decision easy for someone to follow your profile. If you’re looking to enhance your Instagram profile, this is the best place and here are the best Instagram bio for 2024!', 'uploads/67483def6a291-1000047908-01.jpeg');
...
(16, 'uploads/6748110a2583d-1000043318-01.jpeg', 'sajid sajid', 'ali', 'sajidsajid12@gmail.com', '$2y$10$qklfrofUgq99W6PcmOlY7uTtPRW8fU9jxfWaf4i1I97KTdcIsDj4m', '');
...
--
-- Indexes for table `community_profile`
--
...
--
-- AUTO_INCREMENT for table `community_profile`
--
ALTER TABLE `community_profile`
...
--
-- Constraints for table `community_profile`
--
ALTER TABLE `community_profile`
  ADD CONSTRAINT `community_profile_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `register` (`id`) ON DELETE CASCADE;
